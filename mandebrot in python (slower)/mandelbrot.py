...
# width and height 1 zu 1
width = 10000      # von -2 bis 1
height = 10000       # von -1,5 bis 1,5
iterations = 131     # frei wählbar
maxiterations = iterations
xstart = -2          # von -2.5 bis 0.5
xstartsave = xstart
ystart = -1.5          # von -1.5 bis 1.5
distance = 3          # von 0 bis 3
...
for a in range(0,height):
    ...
    for b in range(0,width):
        ...
        if calcresult != maxiterations and calcresult != 0:
